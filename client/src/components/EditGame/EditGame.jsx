...
class EditGame extends Component {
  ...
  handleFormSubmit = (e) => {
    ...
    axios.post(`${process.env.REACT_APP_API_URL}/edit/${this.props.gameID}`, { name, platform, release, genre, image, description, companies, screenshots, similars, category, stock, price })
      .then(() => {
        this.setState({
          ...this.state
        });
