...
export const updateAmount = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
  ...
  const updatedGame = await Game.findByIdAndUpdate({ _id }, { $set: { amount } }, { new: true });
