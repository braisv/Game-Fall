...
export const getCurrentUserCart = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    ...
    const currentUserWithCart = await User.findById(currentUser._id).populate('cart')
